...
- **Virtual environments** - See and reclaim a pipeline's installed packages on the server via `client.venv` ([Virtual Environments](/develop/typescript/methods/venv))
