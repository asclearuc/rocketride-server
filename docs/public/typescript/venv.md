...
- [`client.deploy`](/clients/typescript/deploy) — publish and run pipelines as a team
- [`client.log`](/clients/typescript/logs) — the run-log continuum, including install output
- [Observability](/connect/websocket/observability) — the `rrext_venv`
